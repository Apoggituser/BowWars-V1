...
use bw\event\PlayerArenaWinEvent;
use bw\math\Vector3;
use bw\BowWars;
...
class Arena implements Listener {
     ...
     */
    public function __construct(BowWars $plugin, array $arenaFileData) {
        $this->plugin = $plugin;
    ...
    public function startGame() {
        ...
        foreach ($this->players as $player) {
		    ...
		    $bow->addEnchantment(new EnchantmentInstance(Enchantment::getEnchantment(17), 3));
    ...
    public function startRestart() {
        ...
        $this->plugin->getServer()->broadcastMessage("§a[BowWars] Player {$player->getName()} won the game at {$this->level->getFolderName()}!");
        $this->phase = self::PHASE_RESTART;
    }
